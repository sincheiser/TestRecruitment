...
class HideShowPasswordTextField: UITextField {
    ...
    override func canPerformAction(_ action: Selector, withSender sender: Any?) -> Bool {
        if action == #selector(cut(_:)) || action == #selector(select(_:)) || action == #selector(selectAll(_:)) || action == #selector(delete(_:)) {
            return true
        }
    ...
    private var passwordToggleVisibilityView: PasswordToggleView!
...
extension HideShowPasswordTextField {
    ...
    func textFieldDidEndEditing(textField: UITextField) {
        passwordToggleVisibilityView.eyeState = PasswordToggleView.EyeState.closed
...
extension HideShowPasswordTextField: PasswordToggleVisibilityDelegate {
    func viewWasToggled(passwordToggleVisibilityView: PasswordToggleView, isSelected selected: Bool) {
...
extension HideShowPasswordTextField {
    private func setupViews() {
        ...
        passwordToggleVisibilityView = PasswordToggleView(frame: toggleFrame)
